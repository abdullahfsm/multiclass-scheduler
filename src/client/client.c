...
/* support for multiclass queue */
unsigned int flows_gen=0;
unsigned int flows_fin=0;
struct multi_class_queue *mcq = NULL;
...
int main(int argc, char *argv[])
{
    ...
    /* initialize multiclass scheduler */
    mcq = (struct multi_class_queue *)malloc(sizeof(struct multi_class_queue));
    init_multi_class_queue(mcq, config_file_name, run_request);
    ...
    /* deleting multi-class-queue scheduler */
    printf("===========================================\n");
    printf("Deleting MCQ\n");
    printf("===========================================\n");
    del_multi_class_queue(mcq);
...
void run_request(unsigned int req_id)
{
    ...
    flow.tos = get_tos(mcq, flow.size);   /* ToS = DSCP * 4 */
